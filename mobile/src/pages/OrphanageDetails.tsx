...
interface OrpahangeDetailsRouteParams {
  id: number;
}
...
export default function OrphanageDetails() {
  ...
  const params = route.params as OrpahangeDetailsRouteParams;
  ...
  //Recomendável que toda variável usada dentro do UseEffect esteja colocada como dependência
  ...
  //É interessante que se faça uma tela de loading na parte acima. Shimmer Effect?
